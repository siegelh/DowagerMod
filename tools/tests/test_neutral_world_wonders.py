...
EXPECTED_DATA = {
    "GREAT_SPHINX": ([0, 0, 7], [20, 0, 0, 0, 0, 0]),
    "LIBRARY_OF_NINEVEH": ([0, 0, 7], [0, 20, 0, 0, 0, 0]),
    "TERRACOTTA_ARMY": ([0, 2, 5], [0, 0, 0, 0, 0, 2]),
    "TOMB_OF_CYRUS": ([0, 1, 6], [0, 0, 0, 0, -20, 0]),
    "PERGAMON_ALTAR": ([0, 0, 7], [0, 0, 20, 0, 0, 0]),
    "SUN_TZU_ART_OF_WAR": ([0, 2, 5], [0, 0, 0, 20, 0, 0]),
    "ISHTAR_GATE": ([0, 0, 7], [20, 0, 0, 0, 0, 0]),
    "GREAT_ZIGGURAT_OF_UR": ([0, 1, 6], [0, 0, 0, 0, -20, 0]),
    "EKUR_OF_NIPPUR": ([0, 2, 5], [0, 0, 0, 20, 0, 0]),
    "TEMPLE_OF_THOTH": ([0, 0, 7], [0, 20, 0, 0, 0, 0]),
    "TEMPLE_OF_MELQART": ([0, 2, 5], [0, 0, 0, 0, 0, 2]),
    "ERECHTHEUM": ([0, 0, 7], [0, 0, 20, 0, 0, 0]),
    "LABYRINTH_OF_KNOSSOS": ([0, 1, 6], [0, 0, 0, 0, -20, 0]),
    "SOLOMONS_TEMPLE": ([0, 0, 7], [0, 0, 20, 0, 0, 0]),
}
