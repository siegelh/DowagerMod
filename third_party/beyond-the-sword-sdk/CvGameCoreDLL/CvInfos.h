...
public:
	...
	bool isEstablishesBackchannels() const;
	bool isFabricatesCasusBelli() const;
	int getCasusBelliMinAttitude() const;
	int getCasusBelliMinPowerRatio() const;
	int getCasusBelliBaseChance() const;
	int getCasusBelliAttitudeChancePerPoint() const;
	int getCasusBelliFuriousBonus() const;
	int getCasusBelliMaxChance() const;
...
protected:
	...
	bool m_bEstablishesBackchannels;
	bool m_bFabricatesCasusBelli;
	int m_iCasusBelliMinAttitude;
	int m_iCasusBelliMinPowerRatio;
	int m_iCasusBelliBaseChance;
	int m_iCasusBelliAttitudeChancePerPoint;
	int m_iCasusBelliFuriousBonus;
	int m_iCasusBelliMaxChance;
