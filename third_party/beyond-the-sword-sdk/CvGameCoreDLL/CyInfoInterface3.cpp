...
void CyInfoPythonInterface3()
{
	...
	python::class_<CvEspionageMissionInfo, python::bases<CvInfoBase> >("CvEspionageMissionInfo")
		...
		.def("isStagesDiplomaticIncident", &CvEspionageMissionInfo::isStagesDiplomaticIncident, "bool ()")
		.def("getDiplomaticAttitudeChange", &CvEspionageMissionInfo::getDiplomaticAttitudeChange, "int ()")
		.def("isEstablishesBackchannels", &CvEspionageMissionInfo::isEstablishesBackchannels, "bool ()")
		.def("isFabricatesCasusBelli", &CvEspionageMissionInfo::isFabricatesCasusBelli, "bool ()")
		.def("getCasusBelliMinAttitude", &CvEspionageMissionInfo::getCasusBelliMinAttitude, "int ()")
		.def("getCasusBelliMinPowerRatio", &CvEspionageMissionInfo::getCasusBelliMinPowerRatio, "int ()")
		.def("getCasusBelliBaseChance", &CvEspionageMissionInfo::getCasusBelliBaseChance, "int ()")
		.def("getCasusBelliAttitudeChancePerPoint", &CvEspionageMissionInfo::getCasusBelliAttitudeChancePerPoint, "int ()")
		.def("getCasusBelliFuriousBonus", &CvEspionageMissionInfo::getCasusBelliFuriousBonus, "int ()")
		.def("getCasusBelliMaxChance", &CvEspionageMissionInfo::getCasusBelliMaxChance, "int ()")
