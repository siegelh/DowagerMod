...
- Neutral world wonders v1 (14-wonder pool):
  ...
  - Tile yields: work each wonder and confirm Sphinx/Nineveh/Pergamon give +2 Commerce, Terracotta/Sun Tzu give +2 Production, Cyrus gives +1 Production/+1 Commerce; Ishtar Gate/Temple of Thoth/Erechtheum/Solomon's Temple give +2 Commerce, Great Ziggurat of Ur/Labyrinth of Knossos give +1 Production/+1 Commerce, and Ekur of Nippur/Temple of Melqart give +2 Production
  - Ownership benefits: claim each wonder separately and confirm Sphinx +10% city Culture, Nineveh +10% Research, Terracotta +1 XP only to newly trained land combat units, Cyrus -10% final Civic Upkeep, Pergamon +10% Great Person rate, Sun Tzu +10% military-unit Production, Ishtar Gate +10% city Culture, Great Ziggurat of Ur -10% Civic Upkeep, Ekur of Nippur +10% military-unit Production, Temple of Thoth +10% Research, Temple of Melqart +1 XP to newly trained land combat units, Erechtheum +10% Great Person rate, Labyrinth of Knossos -10% Civic Upkeep, and Solomon's Temple +10% Great Person rate
  ...
  - Named-source UI attribution: with two or more distinct active civic-upkeep wonders owned (e.g. Cyrus + Great Ziggurat of Ur + Labyrinth of Knossos), confirm the Finance Advisor civic upkeep help shows one named line per distinct wonder displaying `-10%` (not `10%` or `+10%`), followed by the authoritative rounded total
