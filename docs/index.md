...
- [`plans/active/2026-07-13-experimental-additive-signatures.md`](plans/active/2026-07-13-experimental-additive-signatures.md) - `Current active plan`. One reversible historical building-class signature addition for each of the 59 playable leader/civilization packages.
- [`plans/active/2026-07-13-industry-building-output-rebalance-proposal.md`](plans/active/2026-07-13-industry-building-output-rebalance-proposal.md) - `Review-only proposal`. Complete 69-row industry cost/output rebalance inventory with a machine-validated live XML snapshot; no runtime changes.
