...
- [`plans/active/2026-09-02-espionage-escalation.md`](plans/active/2026-09-02-espionage-escalation.md) - `Implemented; installed and multiplayer validation pending`. Add Establish Backchannels goodwill and a hatred-scaled Fabricate Casus Belli mission that can begin a native limited-war preparation.
- [`plans/active/2026-09-02-live-building-button-safety.md`](plans/active/2026-09-02-live-building-button-safety.md) - `Implemented; gameplay validation pending`. Correct malformed standalone icon paths for all live building art definitions and prevent reused definitions from bypassing validation.
