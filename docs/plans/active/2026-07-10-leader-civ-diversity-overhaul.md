...
| Charlemagne / Carolingian Empire | Frontier marches, Frankish warfare, and scriptoria | Frankish Axethrower using the dormant Frank package; Scriptorium; retain expansion/GG identity while adding faith/knowledge support | Landsknecht REPLACE; Rathaus REPLACE; trait MODIFY |
