...
# Optional: validate that it's a single letter A–Z
if len(civ_drive) != 1 or not civ_drive.isalpha():
    print("Error: Drive letter must be a single alphabetic character, e.g., C")
    sys.exit(1)
