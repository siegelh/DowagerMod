			...
			if (CyInterface().getInterfaceMode() == InterfaceModeTypes.INTERFACEMODE_SELECTION):
				...
				if ( pHeadSelectedUnit.getOwner() == gc.getGame().getActivePlayer() and g_pSelectedUnit != pHeadSelectedUnit ):
					...
					if pUnitOwner.isTurnActive( ):
						...
						if iUnitType == CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(), "UNIT_PROPHET") and gc.getMap().plot( g_pSelectedUnit.getX(), g_pSelectedUnit.getY() ).isCity():
							pPlayer = g_pSelectedUnit.getOwner()
							
							# Priest of Ki button
							if gc.getPlayer(pPlayer).getStateReligion() == CvUtil.findInfoTypeNum(gc.getReligionInfo, gc.getNumReligionInfos(), "RELIGION_KI"):
								...
								screen.show( "BottomButtonContainer" )
								iCount = iCount + 1
							# Priest of Enki button
							if gc.getPlayer(pPlayer).getStateReligion() == CvUtil.findInfoTypeNum(gc.getReligionInfo, gc.getNumReligionInfos(), "RELIGION_ENKI"):
								...
								screen.show( "BottomButtonContainer" )
								iCount = iCount + 1
							# Priest of Enlil button
							if gc.getPlayer(pPlayer).getStateReligion() == CvUtil.findInfoTypeNum(gc.getReligionInfo, gc.getNumReligionInfos(), "RELIGION_ENLIL"):
								...
								screen.show( "BottomButtonContainer" )
								iCount = iCount + 1
							# Priest of Nanna button
							if gc.getPlayer(pPlayer).getStateReligion() == CvUtil.findInfoTypeNum(gc.getReligionInfo, gc.getNumReligionInfos(), "RELIGION_NANNA"):
								...
								screen.show( "BottomButtonContainer" )
								iCount = iCount + 1
							# Priest of Utu button
							if gc.getPlayer(pPlayer).getStateReligion() == CvUtil.findInfoTypeNum(gc.getReligionInfo, gc.getNumReligionInfos(), "RELIGION_UTU"):
