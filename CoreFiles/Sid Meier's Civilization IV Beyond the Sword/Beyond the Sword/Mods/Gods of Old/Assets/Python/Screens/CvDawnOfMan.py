...
class CvDawnOfMan:
	...
	def interfaceScreen(self):
		...
		bodyString = localText.getText("TXT_KEY_GODS_DAWN_OF_MAN_TEXT_CHANGED_AGAIN", (CyGameTextMgr().getTimeStr(gc.getGame().getGameTurn(), false), self.player.getCivilizationAdjectiveKey(), self.player.getNameKey()))
