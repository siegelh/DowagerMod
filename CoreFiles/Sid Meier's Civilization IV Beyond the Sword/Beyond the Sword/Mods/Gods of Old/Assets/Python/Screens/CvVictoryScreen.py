...
class CvVictoryScreen:
	...
	def showVictoryConditionScreen(self):
		...
		for iLoopVC in range(gc.getNumVictoryInfos()):
			...
			###Gods of Old###				
				if victory.getTextKey() == "TXT_KEY_VICTORY_RELIGIOUS":
					iRow = screen.appendTableRow(szTable)
					screen.setTableText(szTable, 0, iRow, localText.getText("TXT_KEY_VICTORY_SCREEN_RELIGION_DESTROY", ()), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
					screen.setTableText(szTable, 2, iRow, localText.getText("TXT_KEY_VICTORY_SCREEN_HOLY_CITIES_LEFT", ()), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
					screen.setTableText(szTable, 3, iRow, unicode(nHolyCityRivals), "", WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)
