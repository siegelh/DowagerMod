...
class CvDawnOfMan:
	...
	def interfaceScreen(self):
		...
		#bodyString = localText.getText("TXT_KEY_VICTORY_ONE", (CyGameTextMgr().getTimeStr(gc.getGame().getGameTurn(), false), self.player.getCivilizationAdjectiveKey(), self.player.getNameKey()))
		bodyString = localText.getText("TXT_KEY_VICTORY_ONE", ())
