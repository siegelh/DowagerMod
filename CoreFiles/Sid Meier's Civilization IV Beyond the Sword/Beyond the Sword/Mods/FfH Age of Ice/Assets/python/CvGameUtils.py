...
#		return False
	...
	def cannotDoCivic(self,argsList):
		...
		if eCivic == gc.getInfoTypeForString('CIVIC_FINAL_BATTLE'):
			if pPlayer.getCivilizationType() != gc.getInfoTypeForString('CIVILIZATION_AMURITES'):
				return True
			if pPlayer.getUnitClassCount(gc.getInfoTypeForString('UNITCLASS_KYLORIN')) != 1:
				return True
	...
	def AI_unitUpdate(self,argsList):
		...
		if pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_MULCARN'):
			return True

		if pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_HATI'):
			return True

		if pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_GODSLAYER_BLADE'):
			return True

		if pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_GODSLAYER_CROSSGUARD'):
			return True

		if pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_GODSLAYER_HILT'):
			return True

		if pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_MALUS'):
			return True

		if pUnit.getUnitClassType() == gc.getInfoTypeForString('UNITCLASS_FIACRA'):
			if CyGame().getGameTurn() < gc.getDefineINT('FIACRA_FREED_TURN'):
				return True
