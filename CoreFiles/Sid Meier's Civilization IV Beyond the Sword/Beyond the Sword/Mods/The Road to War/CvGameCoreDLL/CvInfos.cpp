...
// Dale - AB: Bombing END
// Dale - RtW: START
m_bDCMParaBuilding(false),
m_bDCMNukesOkay(false),
// Dale - RtW: END
...
void CvBuildingInfo::read(FDataStreamBase* stream)
{
	...
	// Dale - AB: Bombing END
	// Dale - RtW: START
	stream->Read(&m_bDCMParaBuilding);
	stream->Read(&m_bDCMNukesOkay);
	// Dale - RtW: END
...
void CvBuildingInfo::write(FDataStreamBase* stream)
{
	...
	// Dale - AB: Bombing END
	// Dale - RtW: START
	stream->Write(m_bDCMParaBuilding);
	stream->Write(m_bDCMNukesOkay);
	// Dale - RtW: END
...
bool CvBuildingInfo::read(CvXMLLoadUtility* pXML)
{
	...
	// Dale - AB: Bombing END
	// Dale - RtW: START
	pXML->GetChildXmlValByName(&m_bDCMParaBuilding, "bDCMParaBuilding");
	pXML->GetChildXmlValByName(&m_bDCMNukesOkay, "bDCMNukesOkay");
	// Dale - RtW: END
...
void CvLeaderHeadInfo::setTrait(int value, bool onoff)
{
	FAssert(value >= 0 && value < GC.getNumTraitInfos());
	m_pbTraits[value] = onoff;
}

bool CvLeaderHeadInfo::getTrait(int value)
{
	FAssert(value >= 0 && value < GC.getNumTraitInfos());
	return m_pbTraits[value];
}

void CvCivilizationInfo::setTech(int value, bool onoff)
{
	FAssert(value >= 0 && value < GC.getNumTechInfos());
	m_pbCivilizationFreeTechs[value] = onoff;
}

bool CvCivilizationInfo::getTech(int value)
{
	FAssert(value >= 0 && value < GC.getNumTechInfos());
	return m_pbCivilizationFreeTechs[value];
}

void CvCivilizationInfo::setUB(int value, int unit)
{
	FAssert(value >= 0 && value < GC.getNumBuildingClassInfos());
	m_piCivilizationBuildings[value] = unit;
}

int CvCivilizationInfo::getUB(int value)
{
	FAssert(value >= 0 && value < GC.getNumBuildingClassInfos());
	return m_piCivilizationBuildings[value];
}

void CvCivilizationInfo::setUU(int value, int unit)
{
	FAssert(value >= 0 && value < GC.getNumUnitClassInfos());
	m_piCivilizationUnits[value] = unit;
}

int CvCivilizationInfo::getUU(int value)
{
	FAssert(value >= 0 && value < GC.getNumUnitClassInfos());
	return m_piCivilizationUnits[value];
}
...
// Dale - RtW: START
bool CvBuildingInfo::getDCMParaBuilding() const
{
	return m_bDCMParaBuilding;
}

bool CvBuildingInfo::getDCMNukesOkay() const
{
	return m_bDCMNukesOkay;
}
// Dale - RtW: END
