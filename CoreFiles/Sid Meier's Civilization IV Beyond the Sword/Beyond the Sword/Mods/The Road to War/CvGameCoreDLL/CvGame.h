...
public:
	...
	DllExport void setChangeCiv(int value);
	DllExport int getChangeCiv();
protected:
	int m_iChangeCiv;
public:
	// Dale - CCH: Change Civ END
	// Dale - RtW: START
	DllExport void setHistoryEvents(int value);
	DllExport int getHistoryEvents();
	DllExport void setVichyHappened(int value);
	DllExport int getVichyHappened();
	DllExport void rtwGameOver();
	DllExport void setBordersOpen(int team1, int team2);
protected:
	int m_iHistoryEvents;
	int m_iVichyHappened;
public:
	DllExport void setBitterWinter(bool bValue);
	DllExport void setRandomMapWinter();
protected:
	int m_iBitterWinter;
public:
	// Dale - RtW: END
