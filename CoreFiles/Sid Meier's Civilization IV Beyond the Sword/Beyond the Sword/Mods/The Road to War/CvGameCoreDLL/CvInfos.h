...
public:
	// Dale - AB: Bombing END
	// Dale - RtW: START
	bool getDCMParaBuilding() const;
	bool getDCMNukesOkay() const;
protected:
	bool m_bDCMParaBuilding;
	bool m_bDCMNukesOkay;
public:
	// Dale - RtW: END
...
public:
	...
	DllExport int getUB(int value);
	DllExport void setUU(int value, int unit);
	DllExport int getUU(int value);
