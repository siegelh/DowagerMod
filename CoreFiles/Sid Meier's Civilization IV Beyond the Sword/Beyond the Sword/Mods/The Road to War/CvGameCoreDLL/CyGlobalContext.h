...
public:
	...
	int getDCM_CIV_CUSTOMISER() const { return GC.getDCM_CIV_CUSTOMISER(); }
	...
	int getNUM_BATTLE_FEATURES() const { return GC.getNUM_BATTLE_FEATURES(); }
	int getNUM_GAME_FEATURES() const { return GC.getNUM_GAME_FEATURES(); }
