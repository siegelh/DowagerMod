...
void CyGamePythonInterface()
{
	...
	python::class_<CyGame>("CyGame")
		...
		.def("setChangeCiv", &CyGame::setChangeCiv)
		.def("getChangeCiv", &CyGame::getChangeCiv)
		// Dale - CCH: Change Civ END
		// Dale - RtW: START
		.def("setHistoryEvents", &CyGame::setHistoryEvents)
		.def("getHistoryEvents", &CyGame::getHistoryEvents)
		.def("setVichyHappened", &CyGame::setVichyHappened)
		.def("getVichyHappened", &CyGame::getVichyHappened)
		.def("rtwGameOver", &CyGame::rtwGameOver)
		.def("setBordersOpen", &CyGame::setBordersOpen)
		.def("setBitterWinter", &CyGame::setBitterWinter)
		.def("setRandomMapWinter", &CyGame::setRandomMapWinter)
		// Dale - RtW: END
