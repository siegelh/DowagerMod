...
public:
	...
	int getBattleFeaturePrev();
	void setBattleFeaturePrev(int ivalue);
	int getBattleFeatureVariety();
	void setBattleFeatureVariety(int ivalue);
	void setBattleFeature(bool bvalue);
protected:
	int m_iBattleCountdown;
	int m_iBattleFeaturePrev;
	int m_iBattleFeatureVariety;
public:
