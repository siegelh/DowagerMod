...
void CyGlobalContextPythonInterface2(python::class_<CyGlobalContext>& x)
{
	...
	x
		...
		.def("getDCM_CIV_CUSTOMISER", &CyGlobalContext::getDCM_CIV_CUSTOMISER, "int ()")
		...
		.def("getNUM_BATTLE_FEATURES", &CyGlobalContext::getNUM_BATTLE_FEATURES, "int ()")
		.def("getNUM_GAME_FEATURES", &CyGlobalContext::getNUM_GAME_FEATURES, "int ()")
