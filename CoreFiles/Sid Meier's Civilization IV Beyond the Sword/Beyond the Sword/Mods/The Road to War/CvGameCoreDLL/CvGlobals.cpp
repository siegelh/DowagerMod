...
m_iNUM_BATTLE_FEATURES(0),
m_iNUM_GAME_FEATURES(0),
...
void CvGlobals::cacheGlobals()
{
	...
	// Dale - DCM: Globals END
	// Dale - BE: Battle Effect START
	m_iNUM_BATTLE_FEATURES = getDefineINT("NUM_BATTLE_FEATURES");
	m_iNUM_GAME_FEATURES = getDefineINT("NUM_GAME_FEATURES");
	// Dale - BE: Battle Effect END
	// Dale - CCH: Globals START
...
// Dale - BE: Battle Effect START
int CvGlobals::getNUM_BATTLE_FEATURES()
{
	return m_iNUM_BATTLE_FEATURES;
}

int CvGlobals::getNUM_GAME_FEATURES()
{
	return m_iNUM_GAME_FEATURES;
}
// Dale - BE: Battle Effect END
