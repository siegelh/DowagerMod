...
void CyPlayerPythonInterface1(python::class_<CyPlayer>& x)
{
	...
	x
		...
		.def("setLH", &CyPlayer::setLH, "void ()")
		.def("setTrait", &CyPlayer::setTrait, "void ()")
		.def("setTech", &CyPlayer::setTech, "void ()")
		.def("getTech", &CyPlayer::getTech, "bool (int value)")
		.def("setUB", &CyPlayer::setUB, "void ()")
		.def("setUU", &CyPlayer::setUU, "void ()")
		// Dale - CC: Customiser END
		// Dale - RtW: START
		.def("doVichyFrance", &CyPlayer::doVichyFrance)
		.def("doSpanishWar", &CyPlayer::doSpanishWar)
		.def("doAnnexation", &CyPlayer::doAnnexation)
		.def("setNukesOkay", &CyPlayer::setNukesOkay)
		// Dale - RtW: END
