...
public:
	...
	void setChangeCiv(int value);
	int getChangeCiv();
	// Dale - CCH: Change Civ END
	// Dale - RtW: START
	void setHistoryEvents(int value);
	int getHistoryEvents();
	void rtwGameOver();
	void setVichyHappened(int value);
	int getVichyHappened();
	void setBordersOpen(int team1, int team2);
	void setBitterWinter(bool bValue);
	void setRandomMapWinter();
	// Dale - RtW: END
