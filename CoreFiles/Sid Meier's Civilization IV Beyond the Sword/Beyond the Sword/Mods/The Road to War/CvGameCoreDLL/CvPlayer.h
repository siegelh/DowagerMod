...
public:
	...
	DllExport void setLH(int value);
	DllExport void setTrait(int value, bool onoff);
	DllExport void setTech(int value, bool onoff);
	DllExport bool getTech(int value);
	DllExport void setUB(int value, int unit);
	DllExport void setUU(int value, int unit);
	// Dale - CC: Customiser END
	// Dale - RtW: START
	void doVichyFrance(int value1, int value2, int value3, int value4);
	void doSpanishWar(int value1, int value2, int value3, int value4);
	void doAnnexation(int value1);
