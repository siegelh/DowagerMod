...
class CvDawnOfMan:
	...
	def interfaceScreen(self):
		...
		# Main Body text
# RtW Stuff
		szDawnTitle = u"<font=3>" + localText.getText("TXT_KEY_WW2_DOM_SCREEN_TITLE", ()).upper() + u"</font>"
...
# RtW Stuff
		bodyString = localText.getText("TXT_KEY_WW2_DOM_SCREEN_TEXT", (CyGameTextMgr().getTimeStr(gc.getGame().getGameTurn(), false), self.player.getCivilizationAdjectiveKey(), self.player.getNameKey()))
