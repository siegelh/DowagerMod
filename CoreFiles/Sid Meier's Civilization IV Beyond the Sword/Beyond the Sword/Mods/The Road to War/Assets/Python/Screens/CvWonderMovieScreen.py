...
# RtW Stuff
MOVIE_SCREEN_INTRO = 3
MOVIE_SCREEN_EUROPE = 4
MOVIE_SCREEN_PACIFIC = 5
MOVIE_SCREEN_RUSSIA = 6
MOVIE_SCREEN_CHINA = 7
MOVIE_SCREEN_AXIS = 8
MOVIE_SCREEN_ALLIES = 9
# RtW Stuff
...
# RtW Stuff
                elif self.iMovieType == MOVIE_SCREEN_INTRO:
                        self.szMovieFile = "Art/Movies/Intros/RtW_intro.bik"
                elif self.iMovieType == MOVIE_SCREEN_EUROPE:
                        self.szMovieFile = "Art/Movies/Intros/RtW_ESEP1.bik"
                elif self.iMovieType == MOVIE_SCREEN_PACIFIC:
                        self.szMovieFile = "Art/Movies/Intros/RtW_PDEC1.bik"
                elif self.iMovieType == MOVIE_SCREEN_RUSSIA:
                        self.szMovieFile = "Art/Movies/Intros/RtW_EJUN2.bik"
                elif self.iMovieType == MOVIE_SCREEN_CHINA:
                        self.szMovieFile = "Art/Movies/Intros/RtW_PJUL7.bik"
                elif self.iMovieType == MOVIE_SCREEN_AXIS:
                        self.szMovieFile = "Art/Movies/Victory/Conquest.bik"
                elif self.iMovieType == MOVIE_SCREEN_ALLIES:
                        self.szMovieFile = "Art/Movies/Victory/Conquest.bik"
# RtW Stuff
