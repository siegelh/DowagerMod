...
##### RtW Stuff
		screen.addMultilineText(listName, szSpecialText, self.X_SPECIAL_PANE + 15, self.Y_SPECIAL_PANE + 40, self.W_SPECIAL_PANE - (15 * 2),
                    self.H_SPECIAL_PANE - (15 * 2) - 25, WidgetTypes.WIDGET_GENERAL, -1, -1, CvUtil.FONT_LEFT_JUSTIFY)	
