...
################################################
        ...
        def getCongressEnabled( self ):
                ...
                return scriptDict['bCongressEnabled']

        def setCongressEnabled( self, bNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['bCongressEnabled'] = bNewValue
        ...
        def setCivsWithNationalism( self, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['iCivsWithNationalism'] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )    

        def getUNbuilt( self ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['bUNbuilt']

        def setUNbuilt( self, bNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['bUNbuilt'] = bNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )    

        def getInvitedNations( self, iCiv ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lInvitedNations'][iCiv]

        def setInvitedNations( self, iCiv, bNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lInvitedNations'][iCiv] = bNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )                

        def getVotes( self, iCiv ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lVotes'][iCiv]

        def setVotes( self, iCiv, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lVotes'][iCiv] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )  

        def getTempActiveCiv( self, iLoop ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lTempActiveCiv'][iLoop]

        def setTempActiveCiv( self, iLoop, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lTempActiveCiv'][iLoop] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) ) 

        def getTempReqCity( self, iLoop ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lTempReqCity'][iLoop]

        def setTempReqCity( self, iLoop, tNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lTempReqCity'][iLoop] = tNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) ) 

        def getLoopIndex( self ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['iLoopIndex']

        def setLoopIndex( self, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['iLoopIndex'] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) ) 

        def getTempReqCityHuman( self, iLoop ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lTempReqCityHuman'][iLoop]

        def setTempReqCityHuman( self, iLoop, tNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lTempReqCityHuman'][iLoop] = tNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) ) 

        def getTempReqCityNI( self ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['tempReqCityNI']

        def setTempReqCityNI( self, tNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['tempReqCityNI'] = tNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )

        def getTempActiveCivNI( self ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['tempActiveCivNI']

        def setTempActiveCivNI( self, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['tempActiveCivNI'] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )

        def getTempAttackingCivsNI( self, iCiv ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lTempAttackingCivsNI'][iCiv]

        def setTempAttackingCivsNI( self, iCiv, bNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lTempAttackingCivsNI'][iCiv] = bNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )  

        def getNumNationsTemp( self ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['iNumNationsTemp']

        def setNumNationsTemp( self, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['iNumNationsTemp'] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) ) 

        def getBribe( self, iCiv ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lBribe'][iCiv]

        def setBribe( self, iCiv, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lBribe'][iCiv] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )  

        def getCivsToBribe( self, iCiv ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lCivsToBribe'][iCiv]

        def setCivsToBribe( self, iCiv, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lCivsToBribe'][iCiv] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )

        def getMemory( self, iCiv ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['lMemory'][iCiv]

        def setMemory( self, iCiv, iNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['lMemory'][iCiv] = iNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) )

        #from RiseAndFall.py
        def getTempFlippingCityCongress( self ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                return scriptDict['tempFlippingCityCongress']

        def setTempFlippingCityCongress( self, tNewValue ):
                scriptDict = pickle.loads( gc.getGame().getScriptData() )
                scriptDict['tempFlippingCityCongress'] = tNewValue
                gc.getGame().setScriptData( pickle.dumps(scriptDict) ) 
...
##                        print self.getCivsToBribe(i)
        ...
        def goldPopup(self):
                self.showPopup(7621, CyTranslator().getText("TXT_KEY_CONGRESS_NEW", ()), CyTranslator().getText("TXT_KEY_CONGRESS_CORRUPTION_GOLD", ()), ("25%", "50%", "75%"))

        def eventApply7621(self, popupReturn):
                iHuman = utils.getHumanID()                

                if (popupReturn.getButtonClicked() == 0):
                        iGoldOffered = gc.getPlayer(iHuman).getGold()*25/100
                elif (popupReturn.getButtonClicked() == 1):
                        iGoldOffered = gc.getPlayer(iHuman).getGold()*50/100
                elif (popupReturn.getButtonClicked() == 2):
                        iGoldOffered = gc.getPlayer(iHuman).getGold()*75/100
                ...
                if (iTempThreshold <= iGoldOffered):
                        ...
                        pHuman.changeGold(-iTempThreshold)
                        pCiv.changeGold(iTempThreshold)
                                                        ...
                                                        if (cityPlot.isRevealed(iActiveCiv, False) and not city.isCapital()):
                                                                ...
                                                                if (not (city.getOwner() == utils.getHumanID() and gc.getActivePlayer().getNumCities() <=3)):
                                                                        ...
                                                                        if ((not (gc.getPlayer(iActiveCiv).AI_getAttitude(city.getOwner()) >= 3)) or gc.getPlayer(iActiveCiv).isHuman()):
                                                                                ...
                                                                                if (not (gc.getGame().getGameTurn() <= con.tBirth[city.getOwner()] + 20)):
                                                                                                ...
                                                                                                if (not (gc.getTeam(gc.getPlayer(city.getOwner()).getTeam()).isVassal(iActiveCiv)) and not (gc.getTeam(gc.getPlayer(iActiveCiv).getTeam()).isVassal(city.getOwner()))):
                                                                                                        ...
                                                                                                        if (iLoopCiv != con.iEthiopia):
                                                                                                                ...
                                                                                                                if (iActiveCiv in lCivGroups[0]):
                                                                                                                        if (city.getOwner() >= iNumPlayers or (city.getOwner() < iNumPlayers and utils.getStability(city.getOwner()) < 0)):
