...
//Speed: End Modify
		...
		switch (getOwnerINLINE())
	{
			...
			case MALI:
				...
				break;
			case TURKEY:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *160 /100, false, true);
				break;
			case PORTUGAL:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *145 /100, false, true);
				break;
			case INCA:
				changeCultureTimes100(getOwnerINLINE(), getCommerceRateTimes100(COMMERCE_CULTURE) *140 /100, false, true);
				break;
