...
void CyInfoPythonInterface2()
{
	...
	python::class_<CvHandicapInfo, python::bases<CvInfoBase> >("CvHandicapInfo")
		...
		.def("getResearchPercent", &CvHandicapInfo::getResearchPercentByID, "int (int i)") //Rhye
		.def("getDistanceMaintenancePercent", &CvHandicapInfo::getDistanceMaintenancePercent, "int ()")
		.def("getDistanceMaintenancePercent", &CvHandicapInfo::getDistanceMaintenancePercentByID, "int (int i)") //Rhye
		.def("getNumCitiesMaintenancePercent", &CvHandicapInfo::getNumCitiesMaintenancePercent, "int ()")
		.def("getNumCitiesMaintenancePercent", &CvHandicapInfo::getNumCitiesMaintenancePercentByID, "int (int i)") //Rhye
		...
		.def("getCivicUpkeepPercent", &CvHandicapInfo::getCivicUpkeepPercentByID, "int (int i)") //Rhye
		.def("getInflationPercent", &CvHandicapInfo::getInflationPercent, "int ()")
		.def("getHealthBonus", &CvHandicapInfo::getHealthBonus, "int ()")
		.def("getHealthBonus", &CvHandicapInfo::getHealthBonusByID, "int (int i)") //Rhye
