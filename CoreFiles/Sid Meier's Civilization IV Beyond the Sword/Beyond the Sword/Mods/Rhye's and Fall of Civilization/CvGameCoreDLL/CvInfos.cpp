...
int CvHandicapInfo::getResearchPercentByID(PlayerTypes pl) const		
{
	...
	if (GC.getGameINLINE().getHandicapType() == 0) //viceroy
		basePercent = 61; //59 in vanilla and Warlords
	else if (GC.getGameINLINE().getHandicapType() == 2) //emperor
		basePercent = 85; //82 in vanilla and Warlords
	...
	{
	case EGYPT:
		return researchPercent*125/100;
	case INDIA:
		return researchPercent*123/100;
	case CHINA:
		return researchPercent*115/100;
	case BABYLONIA:
		return researchPercent*113/100;
	case GREECE:
		return researchPercent*102/100;
	case PERSIA:
		return researchPercent*9/10;
	case CARTHAGE:
		return researchPercent*9/10;
	case ROME:
		return researchPercent*95/100;
	case JAPAN:
		return researchPercent*95/100; //120 before embassies
	case ETHIOPIA:
		return researchPercent*105/100;
	case MAYA:
		//Rhye - start UP (Mayan)
	...
	case MALI:
		return researchPercent*140/100; //to counter their UP
	case TURKEY:
		return researchPercent*75/100;
	case PORTUGAL:
		return researchPercent*75/100;
	...
	case CELTIA: 
		if (!GET_PLAYER((PlayerTypes)EGYPT).isPlayable()) //late start condition
			return researchPercent*340/100; //Byzantium
		else
