...
public:
	...
	DllExport int countTotalCultureTimes100() const;		//Rhye																					// Exposed to Python
	...
	DllExport void setHasRealBuilding(BuildingTypes eIndex, bool bNewValue);	//Rhye	// Exposed to Python
