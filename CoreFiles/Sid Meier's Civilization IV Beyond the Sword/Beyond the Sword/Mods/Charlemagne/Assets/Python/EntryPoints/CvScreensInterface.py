...
charlemagneScreen = CvCharlemagneScreen.CvCharlemagneScreen()
def showCharlemagneScreen(argsList):
	if (-1 != CyGame().getActivePlayer()):
		charlemagneScreen.interfaceScreen(argsList)
...
HandleInputMap = {  MAIN_INTERFACE : mainInterface,
					...
					SPACE_SHIP_SCREEN : spaceShip,
					CHARLEMAGNE_SCREEN : charlemagneScreen,
