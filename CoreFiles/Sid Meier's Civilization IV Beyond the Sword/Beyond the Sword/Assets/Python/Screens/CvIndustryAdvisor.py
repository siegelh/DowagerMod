...
CORPORATIONS = (
    ...
    ('CORPORATION_2', ('BONUS_VINTAGE_WINE', 'BONUS_CONFECTIONS', 'BONUS_TEMPLE_INCENSE', 'BONUS_SPICE_BLENDS')),
    ('CORPORATION_3', ('BONUS_FINE_SILK', 'BONUS_FINE_DYES', 'BONUS_CUT_GEMS', 'BONUS_GOLD_BULLION', 'BONUS_WORKED_SILVER', 'BONUS_FINE_FURS')),
    ('CORPORATION_4', ('BONUS_IVORY_CARVINGS', 'BONUS_LAMP_OIL', 'BONUS_WORKED_SILVER', 'BONUS_FINE_FURS', 'BONUS_FINE_SILK', 'BONUS_MARBLE_STATUARY')),
    ('CORPORATION_5', ('BONUS_TEMPLE_INCENSE', 'BONUS_SPICE_BLENDS', 'BONUS_CONFECTIONS', 'BONUS_VINTAGE_WINE')),
