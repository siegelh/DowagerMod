	...
	def drawHelpInfo(self):
		...
		for i in range(gc.getNumReligionInfos()):
			...
			if pHolyCity.isNone():
				...
				screen.setLabelAt("", "CivicList", "(%s)" % gc.getPlayer(pHolyCity.getOwner()).getCivilizationAdjective(0), CvUtil.FONT_CENTER_JUSTIFY, xLoop - 18, self.Y_HOLY_CITY+8, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
