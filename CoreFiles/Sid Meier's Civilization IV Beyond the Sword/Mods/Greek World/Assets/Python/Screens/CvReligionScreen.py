...
#				szLabel = localText.changeTextColor(szLabel, gc.getInfoTypeForString("COLOR_YELLOW"))
			...
			#screen.setFittedText(szName, szArea, szLabel, 90, false, true, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
...
#			szLabel = localText.changeTextColor(szLabel, gc.getInfoTypeForString("COLOR_YELLOW"))
		screen.setText(szName, szArea, szLabel, CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)		
                ...
                #Religion names splitted in two rows, to prevent overlapping
		#Changes from here
                xLoop = self.X_RELIGION_START
		screen.setText(self.getReligionTextName(0), szArea, gc.getReligionInfo(0).getDescription(), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION
		screen.setText(self.getReligionTextName(1), szArea, gc.getReligionInfo(1).getDescription(), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION
		screen.setText(self.getReligionTextName(2), szArea, gc.getReligionInfo(2).getDescription(), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION
		screen.setText(self.getReligionTextName(3), szArea, gc.getReligionInfo(3).getDescription(), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION
		screen.setText(self.getReligionTextName(4), szArea, localText.getText("TXT_KEY_RELIGION_MESOPOTAMIAN_WORD1", ()), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION
		screen.setText(self.getReligionTextName(5), szArea, localText.getText("TXT_KEY_RELIGION_GREEK_WORD1", ()), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION
		screen.setText(self.getReligionTextName(6), szArea, localText.getText("TXT_KEY_RELIGION_EGYPTIAN_WORD1", ()), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION

                xLoop = self.X_RELIGION_START + 4*self.DX_RELIGION
		screen.setText("Mesopotamian Polytheism", szArea, localText.getText("TXT_KEY_RELIGION_MESOPOTAMIAN_WORD2", ()), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME + 16, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION            
		screen.setText("Greek Polytheism", szArea, localText.getText("TXT_KEY_RELIGION_GREEK_WORD2", ()), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME + 16, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION            
		screen.setText("Egyptian Polytheism", szArea, localText.getText("TXT_KEY_RELIGION_EGYPTIAN_WORD2", ()), CvUtil.FONT_CENTER_JUSTIFY, xLoop + self.X_RELIGION_AREA, self.Y_RELIGION_AREA + self.Y_RELIGION_NAME + 16, 2*self.DZ, FontTypes.GAME_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1)
                xLoop += self.DX_RELIGION
                #To here
		...
		# Date Founded:
                ...
                #Loop deleted so that each religion has a date that can be earlier than the game start
                #Changes from here
		xLoop = self.X_RELIGION_START
		
		szFounded = localText.getText("2085 BC", ())
		...
		xLoop += self.DX_RELIGION
                ...
                if (gc.getGame().getReligionGameTurnFounded(1) < 0):
                        szFounded = localText.getText("TXT_KEY_RELIGION_SCREEN_NOT_FOUNDED", ())
                else:
                        szFounded = CyGameTextMgr().getTimeStr(gc.getGame().getReligionGameTurnFounded(1), false)
		screen.setLabelAt("", szArea, szFounded, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_FOUNDED, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
                xLoop += self.DX_RELIGION

		szFounded = localText.getText("630 BC", ())
		screen.setLabelAt("", szArea, szFounded, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_FOUNDED, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		xLoop += self.DX_RELIGION

		szFounded = localText.getText("3100 BC", ())
		screen.setLabelAt("", szArea, szFounded, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_FOUNDED, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		xLoop += self.DX_RELIGION

		szFounded = localText.getText("2750 BC", ())
		screen.setLabelAt("", szArea, szFounded, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_FOUNDED, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		xLoop += self.DX_RELIGION
		
		szFounded = localText.getText("1600 BC", ())
		screen.setLabelAt("", szArea, szFounded, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_FOUNDED, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		xLoop += self.DX_RELIGION

		szFounded = localText.getText("2600 BC", ())
		screen.setLabelAt("", szArea, szFounded, CvUtil.FONT_CENTER_JUSTIFY, xLoop, self.Y_FOUNDED, self.DZ, FontTypes.SMALL_FONT, WidgetTypes.WIDGET_GENERAL, -1, -1 )
		xLoop += self.DX_RELIGION
		#To here
