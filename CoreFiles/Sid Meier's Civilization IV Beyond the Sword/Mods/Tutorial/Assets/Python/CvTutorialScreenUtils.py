...
class CvTutorialScreenUtils:
    ...
    HandleInputMap = { CvTutorialAdvisorScreen.TUTORIAL_ADVISOR_SCREEN_ID : tutorialAdvisorScreen,
    ...
    def handleInput (self, argsList):
        ...
        CvUtil.pyPrint("CvTutorialScreenUtils.handleInput --> Tutorial (%s - %s)" %(screenEnum,inputClass))
