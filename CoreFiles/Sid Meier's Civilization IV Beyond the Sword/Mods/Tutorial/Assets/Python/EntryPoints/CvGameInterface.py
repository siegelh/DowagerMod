...
## args to another file that contains your modifications - ie: CvMod or CvTutorial

#
import CvUtil
import CvTutorialGameUtils
from CvPythonExtensions import *

# globals
gc = CyGlobalContext()
normalGameUtils = CvTutorialGameUtils.CvTutorialGameUtils()

def gameUtils():
	'Returns either the tutorial game class or the normal game class'
