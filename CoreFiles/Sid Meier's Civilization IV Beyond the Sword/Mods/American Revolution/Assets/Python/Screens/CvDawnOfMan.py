...
#		iXHeaderPanelRemainingAfterLeader = self.X_LEADER_ICON + self.W_LEADER_ICON + self.iMarginSpace
	...
	def interfaceScreen(self):
		...
		# Main Body text
		szDawnTitle = u"<font=3>" + localText.getText("TXT_KEY_AMREV_TITLE", ()).upper() + u"</font>"
		...
		if (CyGame().getActivePlayer() == 0):	# American Colonists
			bodyString = localText.getText("TXT_KEY_AMREV_STARTUP_SCREEN_COLONIAL", ())
		else:					# British Empire
			bodyString = localText.getText("TXT_KEY_AMREV_STARTUP_SCREEN_BRITISH", ())
